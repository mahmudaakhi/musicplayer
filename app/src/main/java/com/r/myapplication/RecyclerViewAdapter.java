...
public class RecyclerViewAdapter extends RecyclerView.Adapter<VideoHolder> {

    private Context context;
    ArrayList<File> videoArrayList;

    public RecyclerViewAdapter(Context context, ArrayList<File> videoArrayList) {
    ...
    public VideoHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View mview = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.files_list,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull final VideoHolder videoHolder, int i) {
        ...
        videoHolder.txtFileName.setText(Video.fileArrayList.get(i).getName());
...
class VideoHolder extends RecyclerView.ViewHolder{
    ...
    VideoHolder(View view){
        ...
        txtFileName = view.findViewById(R.id.videoFileName);
        imageThumbnail = view.findViewById(R.id.iv_thamnail);
